...
- Replay button to start a new round instantly
- Buttons disabled after win/lose (only replay enabled)
- Kid‑friendly design: big alphabet buttons, bright colors, simple layout
...
- **Strings & Lists** (word state, guesses)
- **Functions & Classes** (organized game logic)
- **GUI programming** (Tkinter widgets, events, canvas drawing)
